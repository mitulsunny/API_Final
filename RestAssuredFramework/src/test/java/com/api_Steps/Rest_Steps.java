...
public class Rest_Steps {
	...
	public void i_want_to_create_a_new_user_with_the_following_information(Map<String, String> data) throws Throwable {
	...
	public void later_I_validate_the_HTTP_Status_code() throws Throwable {
		if (r.statusCode() == 201) {
			...
			System.out.println("An error HTTP code " + r.getStatusCode() + " occured");
		}
	}
